...
// 			btn[i].addEventListener('mouseover', onBtnShowClick);
...
// 		this.removeEventListener('mouseover', onBtnShowClick);
...
// 		this.addEventListener('mouseover', onBtnShowClick);
// 		this.removeEventListener('click', onBtnHiddenClick);
// 	};

// 	for(var i = 0; i < btn.length; i++){
// 		list[i].addEventListener('mouseover', onBtnShowClick);
// 	};
// })();